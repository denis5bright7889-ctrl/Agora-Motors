    ...
    <div className="min-h-screen bg-gray-50">
      <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white">
        <div className="container mx-auto px-4 py-16">
          ...
          <Link to="/listings" className="bg-yellow-500 text-gray-900 px-6 py-3 rounded-lg font-semibold hover:bg-yellow-400 transition">
            Browse Cars
          </Link>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          {popularBrands.map((brand) => (
            <Link key={brand} to={`/listings?brand=${brand}`} className="bg-white p-4 rounded-lg shadow text-center hover:shadow-lg transition">
